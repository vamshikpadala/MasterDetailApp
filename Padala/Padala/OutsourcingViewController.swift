//
//  OutsourcingViewController.swift
//  Padala
//
...
class OutsourcingViewController: UIViewController, UIWebViewDelegate {
	...
	override func viewDidLoad() {
		...
		navigationController?.navigationBar.topItem?.title = "Outsourcing"
		...
		if let url = URL(string: "http://www.codeforce.com/outsourcing/") {
